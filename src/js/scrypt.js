...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.readMoreAbout = readMoreAbout
  window.hideReadMoreAbout = hideReadMoreAbout
  window.readMoreBrends = readMoreBrends
  window.hideReadMoreBrends = hideReadMoreBrends
  ...
  window.readMoreTypes = readMoreTypes
  window.hideReadMoreTypes = hideReadMoreTypes
})
